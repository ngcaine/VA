...
4.	Data from the previous set is opened in tableau using tableaus open add option. R




equired sheet added to the data flow pane.
![](img/AddData.png)
...
7.	Lastly due to N.A. values present in some years, the "Labour Force Participation Rate" data type needs to be change from default character data type to decimal.
