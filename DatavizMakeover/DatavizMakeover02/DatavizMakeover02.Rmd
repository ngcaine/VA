...
Critique = c("**Chart title**: A chart title is not provided for the graphic and left to reader to interpret what the grahpic is about.",
             ...
             "**Use of Adjacency Matrix**: The concept of adajcency matrix may not be familiar to many readers and they may not be aware of what the graphic is trying to show.",
...
Steps <-  c("Start by adding a new sheet by clicking 'new worksheet'.",
            ...
            "Right click on the Time Per Hour pill in filters pane and select show filter to add a filter to the graphic.",
            "Click on the small triangle in the Time per hour filters pane and select 'Single Value Slider' to change its appearance to a slider.",
            "Drag and drop the Day Type pill under origin_sheet table to the filters pane, select 'All' then click okay.",
            "Right click on the Day Type pill in filters pane and select show filter to add a filter to the graphic.",
            "Click on the small triangle in the Day Type filter pane and select 'Single Value list' to change its appearance to a single value input.",
...
Steps <-  c("Start by adding a new sheet by clicking 'new worksheet' icon at the bottom of the window.",
            ...
            "Right click the top X-axis row labels at the top left corner of the worksheet and select hide row field labels to hide them.",
            "Right click the top X-axis column labels at the top centre of the worksheet and select hide column field labels to hide them.",
...
Steps <-  c("Start by adding a new sheet by clicking 'new worksheet' icon at the bottom of the window.",
            "Drag and drop 'destination Sz' pill from under Origin_sheet table to the filters pane. In the pop up menu select All then click ok.",
...
Listed below are some of the observations drawn from the graphic after makeover:
...
aesthetics <- data.frame(Item = c(1),
                         ...
                         Takeaway = c("Visible in the made over visualization is the location of integrated transport hubs represented by nodes with relative higher number of bus trips both to and from these locations. Referencing the land transport authority, transport master plan 2013 (LTMP2013) more interchanges act as locations where communters could shop and have a meal between transfers from bus to mrt. Most visiable of these nodes are Tampines, Bedok north and jurong west."))
...
```{r}
aesthetics <- data.frame(Item = c(3),
                         Obervation = c("Travel between subzones is still obersved."),
                         
                         Takeaway = c("While bus transportation is mainly used for regional sub zone travel, it could be observed by click on a node destinations could also reach the other side of the island. Communters from Jurong west central could be seen having destinations as far as Bedok. This is similarly mentioned in LTMP 2013, that "))
