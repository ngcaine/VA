...
Suggestion = c(" More insights could be indicated as part of the chart title from findings of the visualisation. For example 'Labour Force participation rates sees increase for most age groups from 2010 to 2021'",
               ...
               " Compressing the view in such a manner may confuse the reader and some data reduction or summary could be used such that the full year range is indicated instead. Alternatively the year range could be state in the title. Use of dot points on a line chart will be explored.")
...
Steps <-  c("Start with adding a new worksheet, by clicking the new sheet icon.",
            ...
            "Drag and drop a 'Difference' calculated field to colors. To add colors to the plot to indicating positive and negative values.",
