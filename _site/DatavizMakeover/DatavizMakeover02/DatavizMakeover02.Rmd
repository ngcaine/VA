...
aesthetics <- data.frame(Item = c(1),
                         ...
                         Takeaway = c("Visible in visualization after makeover is the location of integrated transport hubs represented by nodes with relative higher number of bus trips both to and from these locations. Referencing the land transport master plan 2013 (LTMP2013) more interchanges act as locations where communters could shop and have a meal between transfers from bus to mrt. Most visiable of these nodes are Tampines, Bedok north, Jurong west and Woodlands east."))
