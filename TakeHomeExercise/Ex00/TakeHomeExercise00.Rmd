---
title: "Take-Home Exercise 0"
description: |
  In this exercise, I learned how to edit a web article by using distill for RMarkdown. This article was prepared as part of a learning exercise before start of the term for SMU-MITB module ISS608 - Visual Analytics.
  
  This article was prepared before the term as a preparation before start of the term.
author:
  - name: Caine Ng 
...
Next, you will use the code chunk below to install and launch **rmarkdown**, **ggpubr** and **tidyverse** in RStudio.

```{r loading-packages}
packages = c('ggpubr', 'tidyverse', 'rmarkdown')
...
First, let us import the data into R by using [**read_csv**](https://readr.tidyverse.org/reference/read_delim.html)  of [**readr**](https://readr.tidyverse.org/index.html) package.  
...
```{r generating plots, echo = FALSE, fig.width=12, fig.height= 8}
