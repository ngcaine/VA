...
description: |
  Superstore pareto chart of returns and Singapore Gender-Age pyramid.
author:
  - name: Caine Ng 
...
```{r generate pareto chart, fig.width = 15, fig.asp = 0.618, fig.align='center'}
...
```{r generate gender sex pyramid, fig.width= 15, fig.asp=0.618, fig.align='center'}
